...
/// 用于处理寻找物体引用
/// 并显示出来
/// https://github.com/CWHISME/UnityReferencesTree.git
/// </summary>
public class AssetReferenceWindow : EditorWindow
{
    [MenuItem("Assets/Asset References" ,priority = 8000)]
    ...
    [MenuItem("Tools/Open Refernces Find Window" ,priority = 8001)]
    public static void OpenWindow()
    {
        AssetReferenceWindow win = EditorWindow.GetWindow<AssetReferenceWindow>();
