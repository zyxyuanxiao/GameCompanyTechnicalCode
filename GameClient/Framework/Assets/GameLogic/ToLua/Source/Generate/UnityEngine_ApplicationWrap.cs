...
public class UnityEngine_ApplicationWrap
{
	...
	static int set_focusChanged(IntPtr L)
	{
		try
		{
			...
			if (arg0.op == EventOp.Add)
			{
				System.Action<bool> ev = (System.Action<bool>)DelegateTraits<System.Action<bool>>.Create(arg0.func);
	...
	static int set_deepLinkActivated(IntPtr L)
	{
		try
		{
			...
			if (arg0.op == EventOp.Add)
			{
				System.Action<string> ev = (System.Action<string>)DelegateTraits<System.Action<string>>.Create(arg0.func);
