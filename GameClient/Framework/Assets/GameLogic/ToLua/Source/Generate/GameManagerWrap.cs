...
public class GameManagerWrap
{
	...
	{
		L.BeginClass(typeof(GameManager), typeof(BaseManager));
	...
	static int get_Instance(IntPtr L)
	{
		try
		{
			ToLua.PushSealed(L, GameManager.Instance);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_Instance(IntPtr L)
	{
		try
		{
			GameManager arg0 = (GameManager)ToLua.CheckObject(L, 2, typeof(GameManager));
