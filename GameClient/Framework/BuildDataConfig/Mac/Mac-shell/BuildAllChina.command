...
################ 将 xlsx 转成 CSV 格式 ################
python3 ./Mac/py3-Tools/Misc/XlsxToCsv.py
################ 给 CSV 格式的文件添加 key ################
python3 ./Mac/py3-Tools/Misc/add_key_to_csv_tools/add_key_to_csv.py
...
################ 将 CSV 格式的文件转成 cs 文件 ################
#python3 ./Mac/py3-Tools/EntryPoint.py "China" "CSharp"
################ 将 CSV 格式的文件转成 Lua 文件 ################
# python3 ./Mac/py3-Tools/EntryPoint.py "China" "Lua"
################ 将 CSV 格式的文件转成 CSharp和Lua 文件 ################
 python3 ./Mac/py3-Tools/EntryPoint.py "China" "CSharp,Lua"
